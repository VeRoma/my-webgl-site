...
//                         <button key={item} className="group relative px-6 py-2 border border-white/20 rounded-lg bg-black/40 backdrop-blur-md overflow-hidden transition-all hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(0,255,255,0.2)] text-right">
...
//                         {(['low', 'med', 'high'] as QualityMode[]).map((q) => (
//                             <button
//                                 key={q}
//                                 onClick={() => setMode(q)}
